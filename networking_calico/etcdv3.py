...
class Etcd3AuthClient(Etcd3Client):
    ...
    def post(self, *args, **kwargs):
        # Impose a maximum timeout of 3 seconds.  Imposing a timeout
        # is generally a good idea, and specifically we want to
        # protect this code from the apparent etcdserver hang bug at
        # https://github.com/etcd-io/etcd/issues/11377.
        if 'timeout' not in kwargs or kwargs['timeout'] > 3:
            kwargs['timeout'] = 3
        try:
