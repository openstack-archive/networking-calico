...
def with_openstack_sg_prefix(id):
    assert not id.startswith(OPENSTACK_SG_PREFIX)
    return OPENSTACK_SG_PREFIX + id


def without_openstack_sg_prefix(id):
    assert id.startswith(OPENSTACK_SG_PREFIX)
    return id[len(OPENSTACK_SG_PREFIX):]
