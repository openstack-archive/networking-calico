...
class StatusWatcher(etcdutils.EtcdWatcher):
    ...
    def __init__(self, calico_driver):
        ...
        status_path = datamodel_v1.felix_status_dir(self.region_string)
    ...
    def _on_ep_set(self, response, hostname, workload, endpoint):
        ...
        endpoint.
        """
        ep_id = datamodel_v1.get_endpoint_id_from_key(self.region_string,
                                                      response.key)
        if not ep_id:
    ...
    def _on_ep_delete(self, response, hostname, workload, endpoint):
        ...
        endpoint_id = datamodel_v1.get_endpoint_id_from_key(self.region_string,
                                                            response.key)
