...
class CalicoMechanismDriver(mech_agent.SimpleAgentMechanismDriverBase):
    ...
    def create_port_postcommit(self, context):
        ...
        if self._port_is_endpoint_port(port):
            ...
            self._create_dhcp_port(context, port)
    ...
    def update_port_postcommit(self, context):
        ...
        if self._port_is_endpoint_port(port):
            ...
            self._update_dhcp_port(context, port, original)
    ...
    def delete_port_postcommit(self, context):
        ...
        if self._port_is_endpoint_port(port):
            ...
            self.transport.delete_dhcp_port(port)
    ...
    def _create_dhcp_port(self, context, port):
        # TODO(asaprykin): Create profiles for security groups
        self.transport.update_dhcp_port(port)

    def _update_dhcp_port(self, context, port, original):
        # TODO(asaprykin): Update security group profiles
        self.transport.update_dhcp_port(port)
            ...
            while self._epoch == expected_epoch:
                ...
                if self.transport.is_master:
                    ...
                    try:
                        ...
                        # TODO(asaprykin): Resync DHCP ports
