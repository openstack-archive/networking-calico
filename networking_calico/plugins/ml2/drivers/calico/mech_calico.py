...
class CalicoMechanismDriver(mech_agent.SimpleAgentMechanismDriverBase):
    ...
    def _post_fork_init(self):
        ...
        with self._init_lock:
            ...
            # Compatability with older versions of openstack [ mitaka and below ] #
            try:
            ...
            try:
                ...
                LOG.debug("authcfg[project_domain_name] fallback = %s", project_domain_name)

            try:
                project_name = authcfg.project_name
            except cfg.NoSuchOptError:
                project_name = authcfg.admin_tenant_name
                LOG.debug("authcfg[project_name] fallback[admin_tenant_name] = %s", project_name)
