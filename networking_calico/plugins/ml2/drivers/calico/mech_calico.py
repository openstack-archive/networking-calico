...
class CalicoMechanismDriver(mech_agent.SimpleAgentMechanismDriverBase):
    ...
    def _post_fork_init(self, worker_mode=None):
        ...
        with self._init_lock:
            ...
            if (self._my_pid == current_pid and
    ...
    def on_port_status_changed(self, hostname, port_id, status_dict,
        ...
        if (priority == "high" or
            ...
            LOG.debug("put port status queue %s" % str(self._port_status_queue))
    ...
    def _loop_writing_port_statuses(self, expected_epoch):
        ...
        while self._epoch == expected_epoch:
            # Wait for work to do.
            LOG.debug("get port status queue %s" % str(self._port_status_queue))
