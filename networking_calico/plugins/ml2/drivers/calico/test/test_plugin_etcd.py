...
class TestDriverStatusReporting(lib.Lib, unittest.TestCase):
    ...
    def setUp(self):
        ...
        lib.m_oslo.config.cfg.CONF.calico.etcd_host = "localhost"
        lib.m_oslo.config.cfg.CONF.calico.etcd_port = 4001
        lib.m_oslo.config.cfg.CONF.calico.etcd_key_file = "etcd_key_file.pem"
        lib.m_oslo.config.cfg.CONF.calico.etcd_cert_file = "etcd_cert_file.pem"
        lib.m_oslo.config.cfg.CONF.calico.etcd_ca_cert_file = (
            "etcd_ca_cert_file.pem"
        )
