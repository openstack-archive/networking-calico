...
if is_service_enabled calico; then
	...
	stack)
		...
		install)
		    ...
		    git_clone ${CALICO_REPO:-https://github.com/projectcalico/calico.git} $CALICO_DIR ${CALICO_BRANCH:-multinode-devstack}
		    cd $CALICO_DIR
		    pip_install .
...
EOF
		...
		extra)
		    ...
		    run_process calico-bird "/opt/stack/networking-calico/devstack/auto-bird-conf.sh"
